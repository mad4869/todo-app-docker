...
class Todos {
    constructor() {
        ...
        this.todosContainer = document.getElementById('home-todos-container')
    ...
    emptyState() {
        ...
        this.separator.className = 'w-full h-px bg-violet-200'
        this.todosContainer.append(this.separator, container)
    }
}
